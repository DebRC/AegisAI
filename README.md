...
| RAG chat | In progress | Grounded streaming-answer contract, provider, bounded prompt builder, and application-issued citations are defined; orchestration and API work remain. |

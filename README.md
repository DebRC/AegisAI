...
| RAG chat | In progress | Protected, permission-gated RAG chat streams grounded answers and application-issued citations; conversation history and final verification remain. |
